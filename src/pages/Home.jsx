          ...
          <>
              ...
              <div className='h-fit w-full flex md:py-7 md:flex-row flex-col items-center justify-between max-w-7xl px-4 pt-10 md:pt-0 sm:px-10 md:px-8 md:gap-x-0 gap-x-6 xl:gap-x-10 md:mx-auto gap-y-0 md:gap-y-0'>
                <div className='w-[96%] md:w-[50%] flex flex-col gap-y-[20px] items-start sm:items-center justify-between md:items-start' data-aos="fade-up"
                  ...
                  <h1 className='text-[var(--white-primary)] font-bold tracking-[0.6px] text-[33px] sm:text-[40px] sm:text-center md:text-start md:text-[30px] lg:text-[40px] leading-[39px] md:leading-[35px] lg:leading-[40px] md:leading-[36px] lg:leading-[54px]'>
                    <GradientText style={{ fontWeight: "700px" }} tag="h1" text="Hello, I am  Aryan Verma," />
                    MERN stack developer
                  </h1>
                  <p className='text-[var(--white-primary)] text-[13.5px] font-medium tracking-wide sm:text-center md:text-start'>Enter the realm of dynamic web development! Using the MERN stack, I seamlessly integrate MongoDB, Express.js, React, and Node.js to create captivating online experiences. Let's collaborate and bring your vision to life!"</p>
                  <div className='flex sm:gap-x-3 gap-y-3 sm:gap-y-0 flex-col sm:flex-row'>
                    ...
                    <button className='connectBTN px-6 py-3 rounded-[20px] border-[1px] border-[var(--white-secondary)] z-10 text-[var(--white-primary)] font-semibold tracking-[0.5px] text-[12px] hover:transform'><a href="https://drive.google.com/file/d/1DaAa2SGxnWvGsR31WQ08oU7zP7LEYH-f/view" target='_blanck'>SEE MY RESUME</a></button>
                  </div>
                </div>
            ...
            <section className='mx-auto max-w-7xl pt-20 flex flex-col md:flex-row justify-start  md:items-center md:justify-between px-4 sm:px-10 md:px-8'>
              <div className='flex flex-col items-start gap-y-2 md:gap-y-3 pb-6 md:w-[30%] lg:w-[35%] xl:w-[40%] md:pb-0' data-aos="fade-up-right"
                ...
                <GradientText tag="h6" style={{ fontWeight: "700", fontSize: "18px", letterSpacing: "0.6px" }} text="Aryan Verma" />
                <h3 className='font-bold text-[26px] tracking-wide text-[var(--white-primary)]'>MERN Stack Developer </h3>
              </div>
            ...
            <section className='pt-10 md:mx-auto max-w-7xl px-4 sm:px-10 md:px-8 flex flex-col justify-center' id='education' >
              ...
              <div className='grid gap-y-4 grid-cols-1 md:grid-cols-2 gap-x-4'>
                <EducationCard duration="2021-2025" type="Graduation" degree="Bachelor's Degree" degreeType="B-Tech" course="Electrical Engineering" schoolName="JSS ACADEMY OF TECHNICAL EDUCATION" schoolLocation="Noida,Uttar Pradesh, India" cardType={1} />
                <EducationCard duration="2018-2019" type="High School" degree="Intermediate" course="Science (MPC)" schoolName="Gyan deep Public School" schoolLocation="Shikohabad,Uttar Pradesh, India" cardType={2} />
              </div>
            </section>
            ...
            <section className='md:mx-auto max-w-7xl pt-20 px-4 sm:px-10 md:px-8' id='projects'>
              ...
              <div className='flex items-center justify-center w-full mt-8'>
                <button className='bg-[#feb901] transition ease duration-400 text-[#000] py-4 px-7 rounded-[30px] hover:bg-[#d39f0f]'><a className='flex items-center justify-center gap-x-2 text-[19px] font-bold' target='_blanck' href='https://github.com/Aryanverma-tech'><FaGithub className='text-[25px]' /> See Github</a></button>
              </div>
            </section>
            <Contact />
            <TopArrow />
